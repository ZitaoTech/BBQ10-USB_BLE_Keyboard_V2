...
|:---|:---|:---    |:---  |
|BBQ10_V2 |53.13x76.67x13.2mm    |Yes     |Linear      |
...
**Firmware**: Modified ZMK Firmware. [Source code](https://github.com/ZitaoTech/zmk/tree/bbkeyboards_q10_9983)    
...
3. You can see the backlight under the keyboard area is turned on, press the ↑ key on the right under area to enter layer 3 and you can see the backlight of the middle keyboard starts to breath.
...
**Layer2 effect**:![Layer2_blinking](https://github.com/user-attachments/assets/4625e6f1-4a54-4af8-b65f-e57e2b9def02)  
**Layer3 effect**:![8ca57f7c-7fda-4d1c-be7a-d15e63d2c425](https://github.com/user-attachments/assets/aeeb4b91-e546-491b-b3dc-550266fe8fe9)  
